    ...
    <div class="toys" id="toys">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-10 offset-lg-1">
            <div class="toys__alert"><span><?php the_field('question'); ?></span><?php the_field('answer'); ?></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="aboutus" id="aboutus">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="subtitle"><?php the_field('history_subtitle1'); ?></div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="subtitle"><?php the_field('history_subtitle2'); ?></div>
            <div class="aboutus__text">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="subtitle"><?php the_field('history_subtitle3'); ?></div>
            <div class="aboutus__text">
    ...
    <div class="contacts" id="contacts">
      <h1 class="title"><?php the_field('find_title'); ?></h1>
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="contacts__descr underlined">
              <?php the_field('find_text'); ?>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="contacts__map"><?php the_field('map', 2); ?></div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="contacts__info">
              ...
              <div class="contacts__mail">
                ...
                <a href="mailto:<?php the_field('mail', 2) ?>&body=привет?subject=вопрос" class="header__contacts-mail"><?php the_field('mail', 2) ?></a>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            ...
            <!-- <form action="#" class="contacts__feed">
              ...
              <svg class="reject ldt-bounce-in" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="圖層_1" x="0px" y="0px" viewBox="0 0 100 100" style="transform-origin: 50px 50px 0px; width: 40px" xml:space="preserve">
                ...
                <style type="text/css" style="transform-origin: 50px 50px 0px"></style>
              </svg>
            </form> -->
            <div class="contacts__feed">
              <?php echo do_shortcode('[contact-form-7 id="f6df89b" title="Форма отзывов"]') ?>
            </div>
          </div>
        </div>
        <div class="row mt70">
